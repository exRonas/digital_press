...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    "catalog.subtitle": "Архив и поиск периодических изданий",
    ...
    "catalog.view_grid": "Сетка",
    "catalog.view_list": "Список",
  ...
  kz: {
    ...
    "catalog.subtitle": "Мерзімді басылымдар мұрағаты және іздеу",
    "catalog.filters": "Сүзгілер",
    "catalog.search": "Іздеу",
    "catalog.search_placeholder": "Атауы немесе нөмірі...",
    ...
    "catalog.view_grid": "Тор",
    "catalog.view_list": "Тізім",
    "catalog.showing": "Көрсетілуде",
    "catalog.of": "барлығы",
